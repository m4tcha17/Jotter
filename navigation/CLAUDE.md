...
- `RootNavigator.tsx` sets `screenOptions={{ headerShown: false }}` globally — every screen hand-rolls its own back button/header. Don't opt one screen into the native header without revisiting this file and `modules/CLAUDE.md`.
