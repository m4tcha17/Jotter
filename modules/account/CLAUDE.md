...
`AccountScreen.tsx` — account-level settings only (profile info, sign-out). Project-level settings live in `modules/projects/ProjectSettingsScreen.tsx`, not here.
